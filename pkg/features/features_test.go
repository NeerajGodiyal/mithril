...
func TestTransactionV1FeatureGate(t *testing.T) {
	assert.Equal(t, "EnableTxV1", EnableTxV1.Name)
	assert.Equal(t, base58.MustDecodeFromString("txv1aq4pp281K9um3tnPgkfX8UqtFT6wcVW3hNezGLL"), EnableTxV1.Address)
	assert.Contains(t, AllFeatureGates, EnableTxV1)
}
