...
func (voteState *VoteState) SetNewAuthorizedVoter(authorized solana.PublicKey, currentEpoch uint64, targetEpoch uint64, blsPubkey *[48]byte, verify func(epochAuthorizedVoter solana.PublicKey) error, f features.Features) error {
